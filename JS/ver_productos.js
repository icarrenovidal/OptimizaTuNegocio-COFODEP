document.addEventListener("DOMContentLoaded", () => {
  ...
  let currentPage = 1;
  const limit = 12; // productos por página, se puede cambiar
        ...
        prod.unidad_medida
              ...
              <div class="d-flex gap-2 mt-1 mt-md-0">
                ...
                <a href="#" class="btn btn-sm btn-${
                  isAgotado || isInactivo ? "secondary" : "outline-success"
                } btn-add-cart" 
                   data-id="${prod.id_producto}" 
                   ${
                     isAgotado || isInactivo
    ...
    productos.forEach((prod) => {
      ...
      <tr class="${isInactivo ? "opacity-50" : ""}">
          ...
          <td data-label="Acciones" class="actions-cell">
              ...
              <a href="#" class="btn btn-sm btn-${
                isAgotado || isInactivo ? "secondary" : "success"
              } btn-add-cart" 
                 data-id="${prod.id_producto}" 
                 title="${
                   isAgotado
                 ...
                 ${
                  ...
                  <i class="fas fa-${
                    isAgotado ? "ban" : isInactivo ? "ban" : "cart-plus"
                  }"></i>
              </a>
          </td>
      </tr>`;
  ...
  function renderPagination(total) {
    ...
    const maxButtons = 5; // máximo botones de páginas visibles
    ...
    firstBtn.className = `btn btn-sm me-1 ${
      currentPage === 1 ? "btn-secondary" : "btn-outline-primary"
    }`;
    ...
    prevBtn.textContent = "<";
    prevBtn.className = `btn btn-sm me-1 ${
      currentPage === 1 ? "btn-secondary" : "btn-outline-primary"
    }`;
    ...
    nextBtn.textContent = ">";
    nextBtn.className = `btn btn-sm me-1 ${
      currentPage === totalPages ? "btn-secondary" : "btn-outline-primary"
    }`;
